...
public class Carnet implements Serializable {
    ...
    public void selectionRecherche() { // affichage de la selection de critere de recherche
        if (this.nombrePersonne != 0) { //verifie que le tableau n'est pas vide
            Scanner sc = new Scanner(System.in);
            String saisie;
            String nom = "";
            String prenom = "";
            ...
            if (!nom.equals("")) {
                ...
                i = index;
                if (i != -1) {
                    while (i < this.nombrePersonne && this.carnetAdresse[i].getNom().equals(nom)) { //affiche toute les occurrences correspondant au nom + d'autres critères
            ...
            try {
                do { // suppression
                    ...
                    if (saisieInt != -1 && saisieInt < this.nombrePersonne) { //verification de la saisie
